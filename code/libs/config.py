...
DEFAULTS = {
    ...
    "input": {
        ...
        # min size: shortest side, scale jitter can be specified using a list
        # max size: longest side
    ...
    "model": {
        ...
        "backbone": "resnet18",
        # output features from backbone (also as the input features for FPN)
    ...
    "test_cfg": {
        ...
        "score_thresh": 0.1,
        # IoU threshold for NMS (postprocessing)
        "nms_thresh": 0.6,
